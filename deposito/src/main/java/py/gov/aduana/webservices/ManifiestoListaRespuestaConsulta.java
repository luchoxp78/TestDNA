...
/**
 * <p>Java class for manifiestoListaRespuestaConsulta complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="manifiestoListaRespuestaConsulta">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="errores" type="{http://aduana.gov.py/webservices}retorno" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="manifiestos" type="{http://aduana.gov.py/webservices}manifiesto" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "manifiestoListaRespuestaConsulta", propOrder = {
    "errores",
    "manifiestos"
})
public class ManifiestoListaRespuestaConsulta {

    @XmlElement(nillable = true)
    protected List<Retorno> errores;
    @XmlElement(nillable = true)
    protected List<Manifiesto> manifiestos;
     ...
     * 
     */
    public List<Manifiesto> getManifiestos() {
        if (manifiestos == null) {
            manifiestos = new ArrayList<Manifiesto>();
        }
